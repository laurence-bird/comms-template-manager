...
class DynamoTemplateId(db: AmazonDynamoDB,
  ...
  def writeNewVersion(templateManifest: TemplateManifest, commName: String, commType: CommType, brand: Brand, publishedBy: String, channels: List[Channel]): Either[String, Unit] = {
