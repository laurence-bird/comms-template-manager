...
object TemplateVersion {
  def apply(templateManifest: TemplateManifest, commName: String, commType: CommType, publishedBy: String, channels: List[Channel]): TemplateVersion = {
    TemplateVersion(
      templateManifest.id,
...
case class TemplateSummary(templateId: String, commName: String, brand: Brand, commType: CommType, latestVersion: String)
