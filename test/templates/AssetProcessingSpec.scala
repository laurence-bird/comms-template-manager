...
class AssetProcessingSpec extends FlatSpec with Matchers {
  ...
  it should "process uploaded email files" in {
    val bodyHtml = generateUploadedFile("email/body.html", "<html><head></head><body><img src=\"assets/image.png\" alt=\"Smiley face\" height=\"42\" width=\"42\"><img src=\"assets/something/assets/image.png\" alt=\"Smiley face\" height=\"42\" width=\"42\"></body></html>")
    val subject = generateUploadedFile("email/subject.txt", "fsfdsfs<img src=\"assets/something/image.png\" alt=\"Smiley face\" height=\"42\" width=\"42\">")
    ...
    val processedBodyHtml = generateUploadedFile("email/body.html", "<html><head></head><body><img src=\"https://s3-eu-west-1.amazonaws.com/dev-ovo-comms-template-assets/service/commName/1.0/email/assets/image.png\" alt=\"Smiley face\" height=\"42\" width=\"42\"><img src=\"https://s3-eu-west-1.amazonaws.com/dev-ovo-comms-template-assets/service/commName/1.0/email/assets/something/assets/image.png\" alt=\"Smiley face\" height=\"42\" width=\"42\"></body></html>")
    val processedSubject = generateUploadedFile("email/subject.txt", "fsfdsfs<img src=\"https://s3-eu-west-1.amazonaws.com/dev-ovo-comms-template-assets/service/commName/1.0/email/assets/something/image.png\" alt=\"Smiley face\" height=\"42\" width=\"42\">")
    ...
    processedFiles.templateFiles.map(file => (file.path, new String(file.contents))) should contain allOf
      ((processedBodyHtml.path, new String(processedBodyHtml.contents)), (processedSubject.path, new String(processedSubject.contents)), (bodyText.path, new String(bodyText.contents)), (sender.path, new String(sender.contents)))
  }
